...
<td valign="top" class="listfilter" height="20">
    <div class="r1"><div class="b1">
    <input class="listedit" type="text" size="25" maxlength="128" name="where[oxorder][oxbillfname]" value="[{ $where.oxorder.oxbillfname }]">
    </div></div>
</td>
<td valign="top" class="listfilter" height="20">
    <div class="r1"><div class="b1">
	<input class="listedit" type="text" size="25" maxlength="128" name="where[oxorder][oxbilllname]" value="[{ $where.oxorder.oxbilllname }]">
    </div></div>
</td>
<td valign="top" class="listfilter" height="20" colspan="2" nowrap>
    ...
    <!-- FCPAYONE BEGIN -->
    <input class="listedit" type="text" size="7" maxlength="128" name="where[oxorder][fcporefnr]" value="[{ $where.oxorder.fcporefnr }]">
