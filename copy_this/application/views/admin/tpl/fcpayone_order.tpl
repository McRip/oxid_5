...
<!--
        ...
        function onClickCapture(oElement) {
            ...
            if(dCaptureAmount == 0) {
                alert('[{ oxmultilang ident="FCPO_CAPTURE_AMOUNT_GREATER_NULL"}]');
            } else {
                if(confirm('[{ oxmultilang ident="FCPO_ARE_YOU_SURE"}]')) {
            ...
            <td width="45%" valign="top">
                <table>
                    ...
                    [{ if $edit->allowCapture() }]
                        ...
                        [{if $edit->oxorder__oxpaymenttype->value == 'fcpobillsafe'}]
